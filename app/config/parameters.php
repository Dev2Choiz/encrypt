...
$envVar = new ParameterBag(getenv() ?: []);

// local host
$container->setParameter('locahost', 'container_encrypt');

// db
$container->setParameter('database_password', Secrets::get($envVar->get('CONTAINER_MYSQL_PASSWORD')));
$container->setParameter('database_user', Secrets::get($envVar->get('CONTAINER_MYSQL_USER')));
